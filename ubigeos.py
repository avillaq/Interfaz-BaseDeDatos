...
class Ventana(Frame):
    ...
    def fModificar(self):        
        ...
        if clave == '':
            ...
            self.txtLocalidad.insert(0,valores[1])
            self.txtProvincia.insert(0,valores[2])
    ...
    def create_widgets(self):
        ...
        lbl2 = Label(frame2,text="Localidad: ")
        lbl2.place(x=3,y=55)        
        self.txtLocalidad=Entry(frame2)
        self.txtLocalidad.place(x=3,y=75,width=100, height=20)        
        lbl3 = Label(frame2,text="Provincia: ")
        lbl3.place(x=3,y=105)        
        self.txtProvincia=Entry(frame2)
        self.txtProvincia.place(x=3,y=125,width=100, height=20)        
        ...
        self.grid.heading("col1", text="Localidad", anchor=CENTER)
        self.grid.heading("col2", text="Provincia", anchor=CENTER)
